                    ...
                    <div class="register-main">
                        <div class="col-md-6 account-left">
                            <form method="post" action="user/signup" id="signup" role="form" data-toggle="validator">
                                ...
                                <div class="form-group has-feedback">
                                    <label for="confirmPassword">Введите пароль повторно</label>
                                    <input type="password" name="confirmPassword" class="form-control" id="confirmPassword" placeholder="Введите пароль повторно" data-error="Пароли не совпадают" data-match="#password" value="" required>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
